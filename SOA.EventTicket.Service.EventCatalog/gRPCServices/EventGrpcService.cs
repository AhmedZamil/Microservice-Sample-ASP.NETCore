...
namespace SOA.EventTicket.Services.EventCatalog.Services
{
    public class EventGrpcService : Events.EventsBase
    {
        ...
        public override async Task<GetAllEventsResponse> GetAll(
        ...
        public override async Task<GetAllEventsResponse> GetAllByCategoryId(
            GetAllEventsByCategoryIdRequest request, ServerCallContext context)
        {
            var response = new GetAllEventsResponse();
            ...
            GetByEventIdRequest request, ServerCallContext context)
        {
            ...
            var entity = await _eventRepository.GetByEventId(Guid.Parse(request.EventId));
